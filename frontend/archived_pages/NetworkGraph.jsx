...
export default function NetworkGraph() {
  ...
  useEffect(() => {
    ...
    function safeId(str) {
      if ((str || "").toLowerCase().includes("subcontractor")) return "subcontractor";
      ...
      <header className="network-header">
            ...
            <div className="legend" id="rn-network-legend">
              <div className="legend-group">
                ...
                <div className="legend-item"><div className="legend-line" style={{ background: "#f1592d" }} />Subcontractor</div>
              </div>
            </div>
            {/* Helper tour button */}
            <button
