...
// In this version, the hero section takes up the full window
// User must click downward carrot button or scroll down to see additional preview sections
...
export default function Home() {
  ...
  return (
    ...
    <main className="bg-gradient-to-b from-[#f3fdb8] via-white to-[#f3fdb8]">
      ...
      <section
        id="home"
        className="min-h-screen flex flex-col justify-center items-start md:items-center md:text-center text-left w-full px-4
      ...
      >
        <div className="flex flex-col md:items-center md:text-center items-start text-left">
          ...
          <p className="mb-10 ml-2 mr-8 md:mb-16 pt-1 max-w-4xl text-base md:text-justify text-left">
          ...
          <button onClick={() => scrollToSection("preview-database")} className="flex flex-col items-center opacity-50 hover:opacity-100 transition-all mt-2">
      ...
      <section
        id="preview-database"
        className="flex flex-col md:flex-row items-center gap-8 px-12 py-24 w-full"
      >
        ...
        <div className="max-w-xl md:w-1/2 flex flex-col items-start gap-4">
          ...
          <p className="max-w-xl">
            A database tracking companies involved in sourcing and managing data work globally and categorizing them by the type of products they offer and their business models.
          </p>
          <Link to="/database">
      ...
      <section
        id="preview-graphs"
        className="flex flex-col md:flex-row-reverse items-center gap-8 px-16 py-24 w-full"
      >
        <div className="w-full md:w-1/2 flex justify-center">
        ...
        <div className="max-w-xl md:w-1/2 flex flex-col items-start gap-4 md:pl-12">
          ...
          <p className="max-w-xl">
            Interactive visualizations higlighting client, partner, supplier and investor relationships in the industry.
          </p>
          <Link to="/graphs">
