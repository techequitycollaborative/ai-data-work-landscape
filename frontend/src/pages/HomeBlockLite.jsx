...
export default function Home() {
  return (
    <main className="bg-gradient-to-b from-[#f3fdb8] from-40% via-white to-[#f3fdb8]">
      ...
      <section
        id="home"
        className="flex flex-col justify-center items-start md:items-center md:text-center text-left w-full px-4 py-6 md:py-12
                  bg-no-repeat bg-[length:180%] md:bg-[length:75%] md:bg-[position:center_top]"
        style={{ backgroundImage: "url('/globe.png')" }}
      >
        <div className="flex flex-col md:items-center md:text-center items-start text-left md:mt-12">
      ...
      <section className="flex flex-col md:flex-row gap-6 px-12 py-8 md:py-16 w-full">
        ...
        <Link to="/networkgraph" className="group flex-1 flex flex-col gap-4 border-2 border-[#041c2c] rounded p-6 hover:bg-[#041c2c] transition-all duration-200">
          ...
          <p className="text-sm group-hover:text-[#f3fdb8]/80 transition-all duration-200">
          Interactive network graph highlighting customer, partner, and investor relationships in the AI data work industry.
          </p>
          <span className="mt-auto text-sm font-semibold uppercase tracking-widest group-hover:text-[#f3fdb8] transition-all duration-200">
            Explore →
          </span>
