...
export default function Home() {
  return (
    <main className="bg-gradient-to-b from-[#f3fdb8] from-40% via-white to-[#f3fdb8]">
      ...
      <section
        id="home"
        className="flex flex-col justify-center items-start md:items-center md:text-center text-left w-full px-4 py-20
                  bg-no-repeat bg-[length:180%] md:bg-[length:75%] md:bg-[position:center_top]"
        style={{ backgroundImage: "url('/globe.png')" }}
      >
        <div className="flex flex-col md:items-center md:text-center items-start text-left mt-8">
      ...
      <section className="flex flex-col md:flex-row gap-6 px-12 py-6 w-full">
        ...
        <Link to="/database" className="group flex-1 flex flex-col gap-4 border-2 border-[#041c2c] rounded p-6 hover:bg-[#041c2c] transition-all duration-200z">
          ...
          />
          <h3 className="text-3xl group-hover:text-[#f3fdb8] transition-all duration-200">Database</h3>
        ...
        <Link to="/graphs" className="group flex-1 flex flex-col gap-4 border-2 border-[#041c2c] rounded p-6 hover:bg-[#041c2c] transition-all duration-200">
          <img
            src="/graphs-preview.png"
            alt="Graphs preview"
            className="w-full h-48 object-cover rounded shadow-md"
          />
          <h3 className="text-3xl group-hover:text-[#f3fdb8] transition-all duration-200">Graphs</h3>
          <p className="text-sm group-hover:text-[#f3fdb8]/80 transition-all duration-200">
        ...
        <Link to="/profiles" className="group flex-1 flex flex-col gap-4 border-2 border-[#041c2c] rounded p-6 hover:bg-[#041c2c] transition-all duration-200">
          <img
            src="/profiles-preview.png"
            alt="Profiles preview"
            className="w-full h-48 object-cover rounded shadow-md"
          />
          <h3 className="text-3xl group-hover:text-[#f3fdb8] transition-all duration-200">Profiles</h3>
          <p className="text-sm group-hover:text-[#f3fdb8]/80 transition-all duration-200">
