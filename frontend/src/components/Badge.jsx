...
const BADGE_COLORS = {
    ...
    Customer:            { bg: "#0041d9", text: "#fff" },
    Investor:            { bg: "#2d9f8b", text: "#fff" },
    Partner:             { bg: "#712f39", text: "#fff" },
    Subcontractor:       { bg: "#f1592d", text: "#fff" },
    ...
    return (
      <span className="relative inline-block group">
        <span
          ...
          className={`
            inline-block font-bold uppercase px-2 py-0.5 cursor-default
            ${
              label === "Subcontractor"
